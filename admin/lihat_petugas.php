                ...
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                  ...
                  <tbody>
                    <tr align="center">
                      ...
                      <td>
                        <!--button-->
                        <a href="admin.php?url=edit_petugas&id=<?= $data['id_petugas']; ?>" class="btn btn-primary btn-circle">
                          <i class="fa fa-edit"></i>
                        </a>
                        <a href="delete_petugas.php?id=<?= $data['id_petugas']; ?>" class="btn btn-danger btn-circle" 
