...
<body id="page-top">
  ...
  <div class="card shadow">
    ...
    <div class="form-group cols-sm-6">
      <a href="petugas.php?url=verifikasi_wadulan" class="btn btn-primary btn-icon-split">
      ...
      <a href="proses.php?id=<?= $data['id_pengaduan']; ?>" class="btn btn-info btn-icon-split" onclick="return confirm('Yakin Mau Diproses')">
        <span class="icon text-white-50">
