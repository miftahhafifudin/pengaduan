...
<body id="page-top">
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">Tabel Tanggapi Pengaduan</h6>
            </div>
            <div class="card-body">
                ...
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                  ...
                  <tbody>
                    <tr align="center">
                      ...
                      <td>
                        <!--button-->
                        <a href="petugas.php?url=tanggapi_wadulan&id=<?= $data['id_pengaduan']; ?>" class="btn btn-primary btn-icon-split">
